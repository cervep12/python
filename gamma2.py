...
w, i = np.loadtxt("C:\\Users\\Petr\\Downloads\\dataGamma2.txt", usecols=(0, 1), unpack=True)
size = 1
plt.xlim(0,300)
gmodel1 = Model(gaussian)
results = gmodel1.fit(i, x= w,amp = 30000, cen =130.85,wid = 3, C = 3000 )
print(results.fit_report())

f, = plt.plot(w, results.best_fit, c="red",label = "f(x)")
